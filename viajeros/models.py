...
class Viajero (models.Model):
    ...
    nacionalidad = models.ForeignKey(Pais, verbose_name='nacionalidad', related_name="nacionalidades", on_delete=models.PROTECT)
    sexo = models.CharField(max_length=10, default="")
    fecha_nacimiento = models.DateField()
    pais_residencia = models.ForeignKey(Pais, verbose_name='residencia', related_name="residencias", on_delete=models.PROTECT)
